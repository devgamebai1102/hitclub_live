...
(function () {
    ...
    cc.PopupView = cc.Class({
        ...
        properties: {
            ...
            //popup dang message
            nodeMessageUnderWebview: cc.Node,
            spriteMessageUnderWebview: cc.Sprite,
            lbMessageUnderWebview: cc.Label,
        ...
        showMessageUnderWebview: function (message, code) {
            this.spriteMessageUnderWebview.spriteFrame = this.sfMessageInfo;
            this.showMessUnderWebview(message, code);
        },

        showMessageUnderWebviewError: function (message, code) {
            this.spriteMessageUnderWebview.spriteFrame = this.sfMessageError;
            this.showMessUnderWebview(message, code);
        },

        showMessUnderWebview: function (message, code) {
            if (message) {
                this.lbMessageUnderWebview.string = message;
            } else if (message) {
                this.lbMessageUnderWebview.string = 'Đã có lỗi xảy ra';
            } else {
                this.lbMessageUnderWebview.string = 'Đã có lỗi xảy ra (' + code + ')';
            }
            this.nodeMessageUnderWebview.opacity = 0;
            this.nodeMessageUnderWebview.active = true;
            this.animation.stop('openPopupFade');
            this.animation.play('openPopupFade', 0);
        },
