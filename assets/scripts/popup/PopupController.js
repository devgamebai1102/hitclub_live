...
(function () {
    ...
    PopupController = (function () {
        ...
        PopupController.prototype.showMessageUnderWebview = function (message, code) {
            return this.popupView.showMessageUnderWebview(message, code);
        };

        PopupController.prototype.showMessageErrorUnderWebview = function (message, code) {
            return this.popupView.showMessageErrorUnderWebview(message, code);
        };
