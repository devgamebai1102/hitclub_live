...
(function () {
    cc.TaiXiuLivestreamInputBetView = cc.Class({
        ...
        onLoad: function () {
            ...
            cc.TaiXiuLivestreamController.getInstance().setTaiXiuLivestreamInputBetView(this);

            this.reset();
        },

        onDestroy: function () {
            cc.TaiXiuLivestreamController.getInstance().setTaiXiuLivestreamInputBetView(null);
        },
        ...
        //mo cua so input
        openInput: function () {
            cc.TaiXiuLivestreamController.getInstance().resetPositionTX();
        ...
        confirmClicked: function (e,val) {
            ...
            this.lblTextNotiNewGame.string = 'Số dư của bạn không khả dụng';
                ...
                cc.TaiXiuLivestreamController.getInstance().sendRequestOnHub(cc.MethodHubName.BET, this.betValue, this.betSide);
            }
			 this.lbBetXiuTemp.string = 0;
			  this.lbBetTaiTemp.string = 0;
           // this.nodeinputtai.active = true;
